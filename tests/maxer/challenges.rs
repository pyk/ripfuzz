//! The `fixtures/maxer/challenges` harnesses must reach their highest value
//! within the budget granted to their difficulty level.
//!
//! ## Layout
//!
//! - The fixtures under `fixtures/maxer/challenges` are sources of the project
...
fn max_challenges_reach_the_highest_value() {
    let dir = PathBuf::from("fixtures/maxer/challenges");
