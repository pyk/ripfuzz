...
const SCRIPT: &str = "fixtures/exec-script-deployment/ScriptExecutes.sol";
const REVERTING: &str = "fixtures/exec-script-deployment/ScriptWithRevertingConstructor.sol";
const REVERTING_SETUP: &str = "fixtures/exec-script-deployment/ScriptWithRevertingSetup.sol";
const REVERTING_EXEC: &str = "fixtures/exec-script-deployment/ScriptWithRevertingExec.sol";
const CUSTOM_NAME: &str = "fixtures/exec-script-deployment/ScriptCustomName.sol:CustomTarget";
const WRONG_NAME: &str = "fixtures/exec-script-deployment/ScriptCustomName.sol:DoesNotExist";
const MISSING_FILE: &str = "fixtures/exec-script-deployment/ScriptMissing.sol";
...
fn exec_fails_when_contract_name_is_wrong() {
    ...
    assert_eq!(
        err.to_string(),
        "contract `DoesNotExist` not found in `fixtures/exec-script-deployment/ScriptCustomName.sol`, available contracts: CustomTarget, ScriptCustomName"
    );
}
...
fn exec_fails_when_script_file_is_missing() {
    ...
    assert_eq!(
        err.to_string(),
        "script file `fixtures/exec-script-deployment/ScriptMissing.sol` not found"
    );
}
