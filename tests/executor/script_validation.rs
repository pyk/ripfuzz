...
const DIR: &str = "fixtures/executor/script-validation";
...
fn rejects_missing_exec() {
    ...
    assert_eq!(
        err.to_string(),
        "script contract `fixtures/executor/script-validation/ScriptWithoutExec.sol:ScriptWithoutExec` must define an `exec` function"
    );
}
...
fn rejects_exec_with_arguments() {
    ...
    assert_eq!(
        err.to_string(),
        "script contract `fixtures/executor/script-validation/ScriptWithExecArgs.sol:ScriptWithExecArgs` function `exec` must take no arguments"
    );
}
...
fn rejects_payable_exec() {
    ...
    assert_eq!(
        err.to_string(),
        "script contract `fixtures/executor/script-validation/ScriptWithPayableExec.sol:ScriptWithPayableExec` function `exec` must be `external` or `public`, found `payable`"
    );
}
...
fn rejects_setup_with_arguments() {
    ...
    assert_eq!(
        err.to_string(),
        "script contract `fixtures/executor/script-validation/ScriptWithSetupArgs.sol:ScriptWithSetupArgs` function `setup` must take no arguments"
    );
}
...
fn rejects_payable_setup() {
    ...
    assert_eq!(
        err.to_string(),
        "script contract `fixtures/executor/script-validation/ScriptWithPayableSetup.sol:ScriptWithPayableSetup` function `setup` must be `external` or `public`, found `payable`"
    );
}
...
fn rejects_constructor_with_arguments() {
    ...
    assert_eq!(
        err.to_string(),
        "script contract `fixtures/executor/script-validation/ScriptWithConstructorArgs.sol:ScriptWithConstructorArgs` constructor must take no arguments"
    );
}
...
fn rejects_payable_constructor() {
    ...
    assert_eq!(
        err.to_string(),
        "script contract `fixtures/executor/script-validation/ScriptWithPayableConstructor.sol:ScriptWithPayableConstructor` constructor must not be `payable`"
    );
}
