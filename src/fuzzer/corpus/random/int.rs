...
/// bit-specific `literals.int` group is chosen. If it fits within the
/// positive half of the type's range it is returned immediately. If the
/// dice roll misses, or the chosen literal is out of range, the generator
/// falls through.
///
