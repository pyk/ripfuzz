//! Storage-read cheatcode (`vm.load`).

use revm::primitives::{Address, Bytes, U256};

use crate::chain::cheatcodes::{Cheatcode, CheatcodeEffect, decode_address_bytes32_args};
...
mod tests {
    ...
    use crate::chain::cheatcodes::account::Store;
    ...
    fn load_effect_reads_storage() {
        ...
        // build_outcome wraps the raw bytes in an ABI-encoded bytes dynamic value
        // for ReturnBytes, but ReadStorage uses success_bytes_outcome which returns
