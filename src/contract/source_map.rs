...
use crate::corpus::{ContractId, CoverageMap};
...
fn resolve_contract_coverage(
    contract_cov: &crate::corpus::ContractCoverage,
...
mod tests {
    ...
    fn resolve_coverage_maps_pc_to_source_location() {
        ...
        let runtime_id = ContractId::from(artifact.runtime.hash_slow());
        let mut contract_cov = crate::corpus::ContractCoverage::new(artifact.runtime.len());
