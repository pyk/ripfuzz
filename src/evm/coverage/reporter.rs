...
mod tests {
    ...
    fn optimizer_enabled_target_contract_with_lib_linked() {
        ...
        let expected_file =
            "fixtures/coverage-report-optimizer-enabled/reports/TargetContractWithLibLinked.info";
        let expected = fs::read_to_string(expected_file)
            .unwrap_or_else(|_| panic!("expected file not found. actual output:\n{formatted}"));
        assert_eq!(
            formatted.trim(),
    ...
    /// interface.
    #[test]
    fn optimizer_disabled_target_contract_with_interface() {
        let project_path = "fixtures/coverage-report-optimizer-disabled";
        let contract = load_coverage_fixture(
            project_path,
        ...
        let expected_file =
            "fixtures/coverage-report-optimizer-disabled/reports/TargetContractWithInterface.info";
        let expected = fs::read_to_string(expected_file)
            .unwrap_or_else(|_| panic!("expected file not found. actual output:\n{formatted}"));
        assert_eq!(
            formatted.trim(),
    ...
    /// interface.
    #[test]
    fn optimizer_enabled_target_contract_with_interface() {
        let project_path = "fixtures/coverage-report-optimizer-enabled";
        let contract = load_coverage_fixture(
            project_path,
            "src/TargetContractWithInterface.sol:TargetContractWithInterface",
        ...
        let expected_file =
            "fixtures/coverage-report-optimizer-enabled/reports/TargetContractWithInterface.info";
        let expected = fs::read_to_string(expected_file)
            .unwrap_or_else(|_| panic!("expected file not found. actual output:\n{formatted}"));
        assert_eq!(
            formatted.trim(),
    ...
    #[test]
    fn optimizer_disabled_target_contract_with_if() {
        let project_path = "fixtures/coverage-report-optimizer-disabled";
        let contract = load_coverage_fixture(
            project_path,
        ...
        let expected_file =
            "fixtures/coverage-report-optimizer-disabled/reports/TargetContractWithIf.info";
        let expected = fs::read_to_string(expected_file)
            .unwrap_or_else(|_| panic!("expected file not found. actual output:\n{formatted}"));
        assert_eq!(
            formatted.trim(),
