...
mod tests {
    ...
    fn deploy_and_setup() -> (Chain, Address) {
        let contract = load_fixture("src/DealHarness.sol:DealHarness");
    ...
    fn deal_set_in_setup_matches_expected() {
        ...
        let txs = vec![Transaction::new(target).calldata(Bytes::from(
            DealHarness::invariant_dealCall::new(()).abi_encode(),
        ))];
    ...
    fn restore_deal_in_action_preserves_value() {
        ...
        let txs = vec![
            Transaction::new(target).calldata(Bytes::from(
                DealHarness::actionRestoreDealCall::new(()).abi_encode(),
            )),
            Transaction::new(target).calldata(Bytes::from(
                DealHarness::invariant_dealCall::new(()).abi_encode(),
            )),
    ...
    fn batch_sequence_in_single_transaction() {
        ...
        let txs = vec![
            Transaction::new(target).calldata(Bytes::from(
                DealHarness::actionDealSequenceCall::new(()).abi_encode(),
            )),
            Transaction::new(target).calldata(Bytes::from(
                DealHarness::invariant_dealCall::new(()).abi_encode(),
            )),
    ...
    fn mutate_and_restore_preserves_invariant() {
        ...
        let txs = vec![
            Transaction::new(target).calldata(Bytes::from(
                DealHarness::actionMutateDealCall::new(()).abi_encode(),
            )),
            Transaction::new(target).calldata(Bytes::from(
                DealHarness::actionRestoreDealCall::new(()).abi_encode(),
            )),
