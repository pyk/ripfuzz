...
mod tests {
    ...
    fn chain_id_set_in_setup_matches_expected() {
        ...
        let txs = vec![Transaction::new(target).calldata(Bytes::from(
            ChainIdHarness::invariant_chainIdCall::new(()).abi_encode(),
        ))];
    ...
    fn restore_chain_id_in_action_preserves_value() {
        ...
        let txs = vec![
            Transaction::new(target).calldata(Bytes::from(
                ChainIdHarness::actionRestoreChainIdCall::new(()).abi_encode(),
            )),
            Transaction::new(target).calldata(Bytes::from(
                ChainIdHarness::invariant_chainIdCall::new(()).abi_encode(),
            )),
    ...
    fn batch_sequence_in_single_transaction() {
        ...
        let txs = vec![
            Transaction::new(target).calldata(Bytes::from(
                ChainIdHarness::actionChainIdSequenceCall::new(()).abi_encode(),
            )),
            Transaction::new(target).calldata(Bytes::from(
                ChainIdHarness::invariant_chainIdCall::new(()).abi_encode(),
            )),
    ...
    fn mutate_and_restore_preserves_invariant() {
        ...
        let txs = vec![
            Transaction::new(target).calldata(Bytes::from(
                ChainIdHarness::actionMutateChainIdCall::new(()).abi_encode(),
            )),
            Transaction::new(target).calldata(Bytes::from(
                ChainIdHarness::actionRestoreChainIdCall::new(()).abi_encode(),
            )),
