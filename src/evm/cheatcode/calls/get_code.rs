...
mod tests {
    ...
    fn deploy_and_setup() -> (Chain, Address) {
        let contract = load_fixture("src/GetCodeHarness.sol:GetCodeHarness");
        let config = ChainConfig::new("fixtures/harness-contract-with-cheatcodes")
    ...
    fn get_code_set_in_setup_matches_expected() {
        ...
        let txs = vec![
            Transaction::new(target).calldata(Bytes::from(
                GetCodeHarness::getDeployedValueCall::new(()).abi_encode(),
            )),
            Transaction::new(target).calldata(Bytes::from(
                GetCodeHarness::invariant_getCodeCall::new(()).abi_encode(),
            )),
        ];
        ...
        let stored: U256 = GetCodeHarness::getDeployedValueCall::abi_decode_returns(
    ...
    fn restore_get_code_in_action_preserves_value() {
        ...
        let txs = vec![
            Transaction::new(target).calldata(Bytes::from(
                GetCodeHarness::actionGetCodeCall::new(()).abi_encode(),
            )),
            Transaction::new(target).calldata(Bytes::from(
                GetCodeHarness::invariant_getCodeCall::new(()).abi_encode(),
            )),
    ...
    fn batch_sequence_in_single_transaction() {
        ...
        let txs = vec![
            Transaction::new(target).calldata(Bytes::from(
                GetCodeHarness::actionGetCodeSequenceCall::new(()).abi_encode(),
            )),
            Transaction::new(target).calldata(Bytes::from(
                GetCodeHarness::invariant_getCodeCall::new(()).abi_encode(),
            )),
        ...
        let ret = GetCodeHarness::actionGetCodeSequenceCall::abi_decode_returns(&output).unwrap();
    ...
    fn mutate_and_restore_preserves_invariant() {
        ...
        let txs = vec![
            Transaction::new(target).calldata(Bytes::from(
                GetCodeHarness::actionMutateGetCodeCall::new(()).abi_encode(),
            )),
            Transaction::new(target).calldata(Bytes::from(
                GetCodeHarness::actionGetCodeCall::new(()).abi_encode(),
            )),
