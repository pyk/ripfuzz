...
mod tests {
    ...
    fn deploy_and_setup() -> (Chain, Address) {
        let contract = load_fixture("src/ToStringHarness.sol:ToStringHarness");
    ...
    fn setup_derives_well_known_strings() {
        ...
        let txs = vec![
            Transaction::new(target).calldata(Bytes::from(
                ToStringHarness::invariant_addrCall::new(()).abi_encode(),
            )),
            Transaction::new(target).calldata(Bytes::from(
                ToStringHarness::invariant_boolCall::new(()).abi_encode(),
            )),
            Transaction::new(target).calldata(Bytes::from(
                ToStringHarness::invariant_uintCall::new(()).abi_encode(),
            )),
            Transaction::new(target).calldata(Bytes::from(
                ToStringHarness::invariant_intCall::new(()).abi_encode(),
            )),
            Transaction::new(target).calldata(Bytes::from(
                ToStringHarness::invariant_bytes32Call::new(()).abi_encode(),
            )),
            Transaction::new(target).calldata(Bytes::from(
                ToStringHarness::invariant_bytesCall::new(()).abi_encode(),
            )),
        ];
    ...
    fn refresh_in_action_preserves_strings() {
        ...
        let txs = vec![
            Transaction::new(target).calldata(Bytes::from(
                ToStringHarness::actionRefreshAllCall::new(()).abi_encode(),
            )),
            Transaction::new(target).calldata(Bytes::from(
                ToStringHarness::invariant_addrCall::new(()).abi_encode(),
            )),
