...
pub fn fuzzing_stats(
    ...
    output.push_str(&format!(
        "\n\n    ⊕ coverage stats\n    unique contracts : {}\n    total edges      : {}\n    total depths     : {}\n    total reverts    : {}\n    total jumps      : {}\n    total corpus     : {}",
        num(shared_coverage.contract_count() as u64),
        num(shared_coverage.edge_count() as u64),
        num(shared_coverage.depth_count() as u64),
        num(shared_coverage.revert_count() as u64),
        num(shared_coverage.jump_count() as u64),
        num(corpus.stats().item_count as u64),
    ));
