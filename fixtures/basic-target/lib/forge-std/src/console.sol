...
library console {
    ...
    function table(
        ...
        _sendLogPayload(
            abi.encodeWithSignature("table(string[],uint256[])", keys, values)
        );
    }

    function table(string[] memory keys, int256[] memory values) internal pure {
        _sendLogPayload(
            abi.encodeWithSignature("table(string[],int256[])", keys, values)
        );
    }
    ...
    function table(
        ...
        _sendLogPayload(
            abi.encodeWithSignature("table(string[],address[])", keys, values)
        );
    }
    ...
    function table(
        ...
        _sendLogPayload(
            abi.encodeWithSignature("table(string[],bytes32[])", keys, values)
        );
    }

    function table(string[] memory keys, string[] memory values) internal pure {
        _sendLogPayload(
            abi.encodeWithSignature("table(string[],string[])", keys, values)
        );
    }

    function table(string[] memory keys, bool[] memory values) internal pure {
        _sendLogPayload(
            abi.encodeWithSignature("table(string[],bool[])", keys, values)
        );
    }
}
